    ...
    <>
      ...
      <div className="p-6">
        <CardContainer title="Assessment of Documents Permit Applications">
          <PermitManagementTable viewable={true} searchParam={appNo} permitUrl={'/' + role + '/api/permits/assessment'} role={session!.user.role} step={7} refreshNotification={refreshNotification} />
        </CardContainer>
      </div>
    </>
  )
