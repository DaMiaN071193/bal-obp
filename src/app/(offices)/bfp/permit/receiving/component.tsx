    ...
    <>
      ...
      <div className="p-6">
        <CardContainer title="To Be Received Permit Application List">
          <PermitManagementTable viewable={true} searchParam={appNo} permitUrl={'/' + role + '/api/permits/receiving'} role={session!.user.role} step={6} receivingOnly={true} refreshNotification={refreshNotification} />
        </CardContainer>
      </div>
    </>
  )
