...
export default function RejectedPermitApplicationsPage({ appNo }: { appNo?: string }) {
  ...
  const breadcrumb = useMemo(() => [
    ...
    {
      label: 'MPDC Rejected Assessments',
  ...
  return status === "authenticated" && (
    <>
      <BannerWithBreadcrumb
        ...
        title="MPDC Rejected Assessments"
        icon={PeopleIcon}
        description="Manage Rejected Assessments for Compliance with MPDC"
        breadcrumb={breadcrumb}
      />
      <div className="p-6">
        <CardContainer title="MPDC Rejected Assessments for Compliance">
