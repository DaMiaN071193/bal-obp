...
import { ApplicationDocument, AssignationDocument, BuildingPermitType, BuildingScopeOfWork, CharacterOfOccupancyGroupA, CharacterOfOccupancyGroupB, CharacterOfOccupancyGroupC, CharacterOfOccupancyGroupD, CharacterOfOccupancyGroupE, CharacterOfOccupancyGroupF, CharacterOfOccupancyGroupG, CharacterOfOccupancyGroupH, CharacterOfOccupancyGroupI, CharacterOfOccupancyGroupJ1, CharacterOfOccupancyGroupJ2, cooGroup, UserDocument, UserRoles } from "@/lib/models/interfaces"
...
export default function BuildingPermitPrintDocument({ data }: { data?: ApplicationDocument }) {
  ...
  return (
    <div className="printsize-portrait mx-auto">
      ...
      <div className="font-arial-narrow leading-loose hidden print:block">
        <table className="border-collapse w-full">
          <thead>
            <tr>
              <td colSpan={5} className="px-2 text-[10pt]">
                BOX 6
              </td>
            </tr>
          </thead>
          <tbody className="text-[10pt]">
            <tr className="text-[11pt]">
              <th className="border border-black w-[35%]">ASSESSED FEES</th>
              <th className="border border-black w-[10%]">ACCOUNT</th>
              <th className="border border-black w-[25%]">BASIS OF<br/>ASSESSMENT</th>
              <th className="border border-black w-[10%]">AMOUNT DUE</th>
              <th className="border border-black w-[20%]">ASSESSED BY</th>
            </tr>
            <tr>
              <td className="font-bold border border-black pl-1 italic">FOR ZONING (ZONING ADMINISTRATOR):</td>
            ...
            <tr>
              <td className="border border-black">
                <ChevronDownIcon display="inline-block" marginX={8} size={10} />
            ...
            <tr>
              <td className="font-bold border border-black pl-1 italic">FOR BUILDING / STRUCTURE (OBO):</td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
            ...
            <tr>
              <td className="font-bold border border-black pl-1 italic">FOR FIRE SAFETY (BFP):</td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
            ...
            <tr>
              <td colSpan={2} className="text-center font-bold border border-black">
                TOTAL
              </td>
              <td className="border border-black"></td>
              <td className="border border-black"></td>
      ...
      <div className="text-[12pt] mt-2 border border-black p-1 hidden print:block">
        <div className="text-[14pt] font-bold mb-2">TERMS AND CONDITIONS:</div>
        <div className="ml-8 mr-4 mb-2">
          <ol className="list-decimal w-full font-arial-narrow text-justify">
            <li>The Ownership/Applicant shall accomplish the prescribed Unified Application with the assistance of the concerned design professional/s and/or the Architect/Civil Engineer, hired/commissioned by the Owner/Permittee as full-time inspector/supervisor of the construction works, by filling up the nessesary data / information required thereat.</li>
            <li className="mt-4">The fully accomplised prescribed Application Form, duly notarized, shall be submitted to the concerned Office of the Building Official, accompanied by the various applicable ancillary and accessory permits, plans and specifications signed and sealed by the correspoinding design professionals who shall be responsible for the comprehensive and correctness of the plans in compliance to the Natinal Building Code of the Philippines (PD 1096), its Revised IRR and all applicable referral codes and professional regulatory laws, together with the other documentary requirements pursuant to Section 302 of PD 1096 and its IRR.</li>
          </ol>
        </div>
      </div>
      <div className="font-arial-narrow mt-2 hidden print:block">
        <table className="border-collapse w-full">
          <thead className="text-[10pt]">
            <tr>
              <th className="border-t border-x border-t-black border-x-black px-2 w-1/2 text-left">Recommending approval for permit purposes:</th>
              <th className="border-t border-x border-t-black border-x-black px-2 w-1/2 text-left">PERMIT ISSUED BY:</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="px-2 border-x border-x-black border-b border-b-black">
                <div className="flex flex-col mt-16 items-center leading-tight">
                  <p className="underline text-[11pt]">{recommendedApproval?.name || 'Engr. Mart Nikki Lou M. Mantilla, REA'}</p>
                  <p className="text-[10pt]">{recommendedApproval?.position || 'Engineer 1'}</p>
                  <p className="text-[8pt]">(Signature Over Printed Name)</p>
                </div>
              </td>
              <td className="px-2 border-x border-x-black border-b border-b-black">
                <div className="flex flex-col mt-16 items-center leading-tight">
                  <p className="underline text-[11pt]">{permitIssuedBy?.name || 'ENGR. EPIFANIO P. SOTTO, JR, MME'}</p>
                  <p className="text-[10pt]">{permitIssuedBy?.position || 'BUILDING OFFICIAL'}</p>
                  <p className="text-[8pt]">(Signature Over Printed Name)</p>
                </div>
              </td>
            </tr>
            <tr>
              <td colSpan={2} className="border border-black">
                <div className="flex flex-col items-center text-[10pt] mb-2">
                  <div>Date: <span className="underline">{(new Date()).toLocaleDateString('en-US', { day: 'numeric', year: "numeric", month: "long"})}</span></div>
                  <div className="font-bold uppercase">NOTE: THIS PERMIT MAYBE CANCELLED OR REVOKED PURSUANT TO SECTIONS 305 and 306 OF THE CODE</div>
                </div>
              </td>
            </tr>
          </tbody>
