...
export default function SanitaryPermitPrintDocument({ data }: { data?: ApplicationDocument }) {
  ...
  return (
    <div className="printsize-portrait mx-auto">
      ...
      <div className="text-[10pt] ml-2 font-arial-narrow leading-loose mt-20 hidden print:block">TO BE ACCOMPLISED BY THE PROCESSING & EVALUATION DIVISION</div>
      <div className="font-arial-narrow leading-loose mt-4 hidden print:block">
        <table className="border-collapse w-full text-left">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <td colSpan={2} className="font-bold text-center border-x border-x-black">FIVE (5) SETS OF SANITARY DOCUMENTS</td>
            </tr>
            <tr>
              <td className="text-[9pt] text-center border-l border-l-black border-b border-b-black px-4 pb-4 pt-2 w-1/2">
                <div className="grid grid-cols-1 whitespace-nowrap text-left items-start">
                  <label className="square-radio">
                    ...
                    <span className="uppercase">{FiveSetOfSanitaryDocumentsEnum.SanitaryPlansAndSpecifications}</span>
                  </label>
                  <label className="square-radio">
                    <input type="radio" radioGroup="fiveSet" />
                    <span className="uppercase">{FiveSetOfSanitaryDocumentsEnum.BillOfMaterials}</span>
                  </label>
                </div>
              </td>
              <td className="text-[9pt] text-center border-r border-r-black border-b border-b-black p-4 w-1/2">
                <div className="grid grid-cols-1 whitespace-nowrap text-left items-start">
                  <label className="square-radio">
                    <input type="radio" radioGroup="fiveSet" />
                    <span className="uppercase">{FiveSetOfSanitaryDocumentsEnum.CostEstimates}</span>
                  </label>
                  <label className="square-radio">
                    <input type="radio" radioGroup="fiveSet" />
                    <span className="uppercase">{FiveSetOfSanitaryDocumentsEnum.Others} <div className="inline-block capitalize">(Specify)</div></span>
                  </label>
      ...
      <div className="mt-4 font-arial-narrow leading-normal hidden print:block">
        <table className="border-collapse w-full text-left">
          <thead>
            <tr>
              <td className="px-2 text-[10pt]">BOX 8</td>
              <td className="px-2 text-[10pt]">&nbsp;</td>
              <td className="px-2 text-[10pt]">&nbsp;</td>
              <td className="px-2 text-[10pt]">&nbsp;</td>
              <td className="px-2 text-[10pt]">&nbsp;</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colSpan={2} rowSpan={2} className="text-center border border-black w-1/4">PROCESSED BY</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="text-center border border-black w-1/8">&nbsp;</td>
              <td className="text-center border border-black w-1/8">&nbsp;</td>
              <td colSpan={2} className="text-center border border-black w-1/8">&nbsp;</td>
            </tr>
            <tr>
      ...
      <div className="text-[10pt] ml-2 font-arial-narrow leading-none my-4 hidden print:block">BOX 9</div>
      <div className="text-[12pt] mt-2 border border-black p-2 px-4 hidden print:block font-arial-narrow">
        <div className="text-[12pt] font-bold mt-2 mb-6">ACTION TAKEN:</div>
        <div className="ml-8 mr-4 mb-2">
          ...
          <ol className="list-decimal w-full font-arial-narrow text-justify">
            <li>That the proposed sanitary works shall be in accordance with the sanitary plans field with this Office and in comformity with the latest Code on Sanitary of the Philippines, the National Building Code and its IRR.</li>
            <li>That prior to any commencement of sanitary works, a duly accomplished prescribed <q className="font-bold">Notice of Construction</q> shall be submitted to the Office of the Building Official.</li>
            <li>That upon completion of the sanitary works, the licensed supervisor/in-charge shall submit the entry to the logbook duly signed and sealed to the Building Official including as-built plans and other documents and shall also accokmplish the Certificate of Completion stating that the sanitary works conform to the provision of the Code on Sanitation, the National Building Code and its IRR.</li>
            <li>That this permit is null and void unless accomplied by the building permit.</li>
          </ol>
        </div>
        ...
        <div className="relative w-full pr-6 my-4 min-h-[8mm]">
          <div className="right-0 top-0 absolute">
            <div className="flex flex-col w-fit">
              ...
              <div className="text-[10pt] text-center">{recommendedApproval?.position || 'Engineering 1'}</div>
            </div>
          </div>
        </div>
