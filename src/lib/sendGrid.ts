...
import { ApplicationStatus, UserRoles } from "./models/interfaces";
...
export async function sendEmailNotification(toEmail: string, fullName: string, applicationNo: string, messages: ApplicationStatus[], role: UserRoles = UserRoles.User) {
